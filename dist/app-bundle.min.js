...
// Module
exports.push([module.i, "/*\r\n * This file was auto-generated using SASS\r\n * You can manually modify it - but usually you will want to \r\n * Re-generate it using the SASS variables of your theme\r\n*/\n@media all {\n  .co-accordion-wrapper {\n    margin-bottom: 30px; }\n    .co-accordion-wrapper .co-accordion-title {\n      border-bottom: 1px solid #e9ecef;\n      cursor: pointer;\n      position: relative;\n      color: #555555;\n      transition: color 0.3s linear, border-color 0.3s linear; }\n      .co-accordion-wrapper .co-accordion-title:hover {\n        color: #4A148C;\n        border-color: #4A148C; }\n      .co-accordion-wrapper .co-accordion-title:after {\n        content: \"\\f067\";\n        position: absolute;\n        right: 10px;\n        width: 20px;\n        height: 20px;\n        line-height: 20px;\n        text-align: center;\n        font-size: 12px;\n        top: 50%;\n        margin-top: -10px;\n        display: block;\n        font-family: 'Font Awesome\\ 5 Free';\n        font-weight: 900;\n        text-rendering: auto;\n        -webkit-font-smoothing: antialiased;\n        -moz-osx-font-smoothing: grayscale;\n        color: #4A148C;\n        border-radius: 50%; }\n      .co-accordion-wrapper .co-accordion-title.active {\n        border: none; }\n        .co-accordion-wrapper .co-accordion-title.active h2:after {\n          display: block;\n          left: 30px; } }\n        @media all and (min-width: 992px) {\n          .co-accordion-wrapper .co-accordion-title.active h2:after {\n            left: 45px; } }\n\n@media all {\n      .co-accordion-wrapper .co-accordion-title.active:after {\n        content: \"\\f068\";\n        background: #e9ecef; }\n      .co-accordion-wrapper .co-accordion-title h2,\n      .co-accordion-wrapper .co-accordion-title h3 {\n        display: block;\n        font-size: 16px;\n        font-weight: bold;\n        padding: 20px 30px;\n        position: relative;\n        margin: 0;\n        line-height: 135%; } }\n      @media all and (min-width: 992px) {\n        .co-accordion-wrapper .co-accordion-title h2,\n        .co-accordion-wrapper .co-accordion-title h3 {\n          max-width: 80%;\n          font-size: 18px;\n          padding: 30px 45px; } }\n\n@media all {\n        .co-accordion-wrapper .co-accordion-title h2:after,\n        .co-accordion-wrapper .co-accordion-title h3:after {\n          display: none; }\n        .co-accordion-wrapper .co-accordion-title h2.co-no-icon,\n        .co-accordion-wrapper .co-accordion-title h3.co-no-icon {\n          padding-left: 0; }\n        .co-accordion-wrapper .co-accordion-title h2 span,\n        .co-accordion-wrapper .co-accordion-title h3 span {\n          position: absolute;\n          left: 0;\n          /* bottom: 0; */\n          /* top: 0; */\n          display: flex;\n          align-items: center;\n          font-size: 18px;\n          color: #e9ecef; } }\n        @media all and (min-width: 992px) {\n          .co-accordion-wrapper .co-accordion-title h2 span,\n          .co-accordion-wrapper .co-accordion-title h3 span {\n            font-size: 25px; } }\n\n@media all {\n    .co-accordion-wrapper .co-accordion-content {\n      display: none;\n      background-color: transparent;\n      padding: 30px;\n      padding-top: 0; } }\n    @media all and (min-width: 768px) {\n      .co-accordion-wrapper .co-accordion-content {\n        padding: 45px;\n        padding-top: 0; } }\n\n@media all {\n      .co-accordion-wrapper .co-accordion-content h1,\n      .co-accordion-wrapper .co-accordion-content h2,\n      .co-accordion-wrapper .co-accordion-content h3 {\n        margin: 0;\n        margin-bottom: 12px;\n        color: #4A148C;\n        font-size: 1rem;\n        font-weight: normal; } }\n      @media all and (min-width: 768px) {\n        .co-accordion-wrapper .co-accordion-content h1,\n        .co-accordion-wrapper .co-accordion-content h2,\n        .co-accordion-wrapper .co-accordion-content h3 {\n          font-size: 1rem; } }\n\n@media all {\n      .co-accordion-wrapper .co-accordion-content .co-content {\n        margin-bottom: 10px; } }\n      @media all and (min-width: 768px) {\n        .co-accordion-wrapper .co-accordion-content .co-content {\n          margin-bottom: 15px; } }\n\n@media all {\n    .co-accordion-wrapper .question-wrapper {\n      transition: opacity .4s ease-in-out; }\n    .co-accordion-wrapper .faq-category-wrapper {\n      margin-bottom: 30px; }\n      .co-accordion-wrapper .faq-category-wrapper ul {\n        list-style: none;\n        padding: 0; }\n        .co-accordion-wrapper .faq-category-wrapper ul li.faq-category-element {\n          display: inline-block;\n          cursor: pointer;\n          padding: 8px;\n          font-size: 0.85em;\n          color: #6c757d;\n          border: 1px solid #ced4da;\n          border-radius: 8px;\n          transition: .2s linear color, .2s linear border-color; }\n          .co-accordion-wrapper .faq-category-wrapper ul li.faq-category-element:hover {\n            color: #000;\n            border-color: #000; }\n          .co-accordion-wrapper .faq-category-wrapper ul li.faq-category-element.co-active {\n            color: #4A148C;\n            border: 1px solid #4A148C; }\n  .faq-admin-table-wrapper {\n    border: 1px dashed red;\n    color: red;\n    border-radius: 8px;\n    padding: 15px;\n    margin-bottom: 30px; }\n    .faq-admin-table-wrapper .faq-admin-warning {\n      font-weight: bold; }\n  .faq-admin-msg {\n    color: red; } }\n", ""]);
